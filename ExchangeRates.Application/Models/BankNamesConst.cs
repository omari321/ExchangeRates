...
public class BankNamesConst
{
    ...
    public const string SilkBank = "Silk Bank";
    public const string ProcreditBank = "Procredit Bank";
    public const string PashaBank = "Pasha Bank";
    public const string LibertyBank = "Liberty Bank";
    public const string IshBank = "Ish Bank";
    public const string HalykBank = "Halyk Bank";
